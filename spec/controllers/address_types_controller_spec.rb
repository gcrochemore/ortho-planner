...
RSpec.describe AddressTypesController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all address_types as @address_types" do
      address_type = AddressType.create! valid_attributes
      get :index, params: {}, session: valid_session
      expect(assigns(:address_types)).to eq([address_type])
    end
  end

  describe "GET #show" do
    it "assigns the requested address_type as @address_type" do
      address_type = AddressType.create! valid_attributes
      get :show, params: {id: address_type.to_param}, session: valid_session
      expect(assigns(:address_type)).to eq(address_type)
    end
  end

  describe "GET #new" do
    it "assigns a new address_type as @address_type" do
      get :new, params: {}, session: valid_session
      expect(assigns(:address_type)).to be_a_new(AddressType)
    end
  end
  ...
  describe "GET #edit" do
    it "assigns the requested address_type as @address_type" do
      address_type = AddressType.create! valid_attributes
      get :edit, params: {id: address_type.to_param}, session: valid_session
      expect(assigns(:address_type)).to eq(address_type)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created address_type as @address_type" do
        post :create, params: {address_type: valid_attributes}, session: valid_session
        expect(assigns(:address_type)).to be_a(AddressType)
        expect(assigns(:address_type)).to be_persisted
      end

      it "redirects to the created address_type" do
        post :create, params: {address_type: valid_attributes}, session: valid_session
        expect(response).to redirect_to(AddressType.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved address_type as @address_type" do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "redirects to the address_type" do
        address_type = AddressType.create! valid_attributes
        put :update, params: {id: address_type.to_param, address_type: valid_attributes}, session: valid_session
        expect(response).to redirect_to(address_type)
      end
    end

    context "with invalid params" do
      it "assigns the address_type as @address_type" do
        address_type = AddressType.create! valid_attributes
